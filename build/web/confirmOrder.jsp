                ...
                <div class="col-xl-6 offset-xl-3 col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-8 offset-sm-2 col-12">
                    <div style="border-radius: 15px; border-color: #555555 !important;" class="cart border p-4">
                        <div id="tableInfo">
                            ...
                            <hr/>
                            <small ><span class="font-weight-bold">Total Price - RM</span> <%= totalPrice %></small> <br/>
                            <small ><span class="font-weight-bold">Delivery Charge - RM</span> <%= (totalPrice>=699)?0:70 %></small><br/>
                            <small ><span class="font-weight-bold">Total Order Price - RM</span> <%= ((totalPrice>=699)?0:70)+totalPrice %></small>
                        ...
                        <div id="paymentMethod" style="display: none">
                            ...
                            <label class="mt-3" ><span class="font-weight-bold">Total Order Price - RM</span> <%= ((totalPrice>=699)?0:70)+totalPrice %></label><br/>
