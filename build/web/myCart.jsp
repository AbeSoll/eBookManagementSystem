    ...
    <body>
        ...
        <div class="container-md mt-4 mb-5">
            ...
            %>
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <label style="font-size: 18px"><span class="font-weight-bold">Total Book Price - RM</span> <%= totalBookPrice %></label> <br/>
                            <label style="font-size: 18px"><span class="font-weight-bold">Delivery Charge - RM</span> <%= (totalBookPrice>=699)?0:70 %></label>
                        </div>
                    </div>
