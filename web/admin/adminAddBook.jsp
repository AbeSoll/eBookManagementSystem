            ...
            <form id="addBook" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-xl-6 offset-xl-3 col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-12">
                        ...
                        <input type="number" class="form-control" id="price" name="price" placeholder="RM 500" required="required"/>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                form.addEventListener('submit', function(event) {
                    ...
                    setTimeout(function() {
                        // Play success sound
                        const audio = new Audio('./sound/correct-answer.mp3'); // Adjust path to match your project structure
                        audio.play();

                        // Optionally, show a success message
                        document.getElementById('status').textContent = 'Book added successfully!';
